...
public class SelectAdminCriteriaForCal implements java.io.Serializable {
	...
	public SelectAdminCriteriaForCal() {}


	public SelectAdminCriteriaForCal(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage,
			int endPage, int startRow, int endRow, String searchCondition, String searchValue, String searchStartDate,
			String searchEndDate, String searchStatusValue) {
		super();
		this.pageNo = pageNo;
	...
	public String toString() {
		return "SelectCriteria [pageNo=" + pageNo + ", totalCount=" + totalCount + ", limit=" + limit
				...
				+ searchEndDate + ", searchStatusValue=" + searchStatusValue + "]";
	}
