...
public class AdminPagenation {
	...
	public static SelectAdminCriteria getSelectAdminCriteria(int pageNo, int totalCount, int limit, int buttonAmount) {
		
		return getSelectAdminCriteria(pageNo, totalCount, limit, buttonAmount, null, null, null, null, null, null);
	}
	
	/* 검색어가 존재하는 경우 검색 조건으로 select 후 페이징 처리를 하기 위한 용도 */
	public static SelectAdminCriteria getSelectAdminCriteria(int pageNo, int totalCount, int limit, int buttonAmount, String searchCondition, 
			String searchValue, String searchStartDate, String searchEndDate, String searchStatus, String searchStatusValue) {
